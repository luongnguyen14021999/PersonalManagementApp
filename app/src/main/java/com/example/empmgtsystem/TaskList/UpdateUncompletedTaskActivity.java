...
public class UpdateUncompletedTaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch_Status1.setChecked(false);
    ...
    public void btnUpdateTask(View view) {
        ...
        startActivity(new Intent(UpdateUncompletedTaskActivity.this, ShowAllTaskActivity.class ));
    }
}